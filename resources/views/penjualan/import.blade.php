<form action="{{ url('/penjualan/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
    <div id="modal-master" class="modal-dialog modal-lg" role="document"> <!-- Ini cukup -->
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file_penjualan" id="file_stok" class="form-control" required>
                    <small id="error-penjualan" class="error-text form-text text-danger"></small>
                </div>
            </div>
